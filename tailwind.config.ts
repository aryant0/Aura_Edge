  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Custom colors for AURAEDGESTUDIOS
        aura: {
          orange: "#FF6B00",
          orangeLight: "#FF7A1A",
          black: "#1A1A1A",
      ...
      fontFamily: {
        ...
        subheading: ["General Sans", "sans-serif"],
